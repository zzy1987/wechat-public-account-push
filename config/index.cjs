...
const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      useTemplateId: 'TBEL8a-Ko4d4IJs7mEJw77zlaz4Jcc82F2HbGkVtMJc',
      // 新历生日, 仅用作获取星座运势, 格式必须为MM-DD
      horoscopeDate: '12-27',
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {
          type: '*生日', name: '津津', year: '1999', date: '09-24',
        },
        ...
        {
          type: '节日', name: '相识纪念日', year: '2020', date: '02-06',
        },
      ],
      // 我们在一起已经有xxxx天了的配置
      customizedDateList: [
  ...
  CALLBACK_TEMPLATE_ID: 'TBEL8a-Ko4d4IJs7mEJw77zlaz4Jcc82F2HbGkVtMJc',
